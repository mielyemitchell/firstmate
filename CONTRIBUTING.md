...
for test_script in tests/*.test.sh; do bash "$test_script"; done   # behavior tests, matching CI; no-mistakes commands.test additionally skips live-Herdr-gated tests (see docs/configuration.md#gate-defaults-no-mistakesyaml)
