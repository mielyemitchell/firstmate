...
test_agents_backlog_task_note_contract() {
  ...
  assert_grep 'bin/fm-tasks-axi.sh show <id> --full' "$agents" "AGENTS.md does not require inspecting task notes first"
  assert_grep 'bin/fm-tasks-axi.sh update <id> --body-file <path>' "$agents" "AGENTS.md does not require task body replacement"
