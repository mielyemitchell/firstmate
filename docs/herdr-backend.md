...
Verified against the real installed binary: herdr 0.7.3, protocol 16, macOS aarch64.
...
- `herdr` itself, protocol 16 or newer (installed 0.7.3 verified) - see [herdr.dev](https://herdr.dev) for install instructions.
